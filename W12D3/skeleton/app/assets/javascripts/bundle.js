  ...
  handleClick(){
    this.el.on("click",(e) =>{
      ...
      if (this.followState === true){
        ...
        _api_util_js__WEBPACK_IMPORTED_MODULE_0__["default"].unfollowUser(this.pageId).then(this.success())// this.render()
      }
      else{
        _api_util_js__WEBPACK_IMPORTED_MODULE_0__["default"].followUser(this.pageId).then(this.success())
      }
...
$(() => {
  let ft = new _follow_toggle_js__WEBPACK_IMPORTED_MODULE_0__["default"] ($(".follow-toggle"));
  let search = new _users_search_js__WEBPACK_IMPORTED_MODULE_1__["default"] ($(".user-search"));
