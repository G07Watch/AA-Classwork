...
export default {
  ...
  ADD_GOD_RELATIVE: gql`
    mutation addGodRelative($godId: ID, $relativeId: relativeID, $relationship: String){
  ...
  REMOVE_GOD_RELATIVE: gql`
    mutation removeGodRelative($godId: ID, $relativeId: relativeID, $relationship: String){
